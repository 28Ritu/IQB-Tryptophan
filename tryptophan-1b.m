% ODE for tryptophan production with feedback regulation
function [t,y] = tryptophan1()
    ...
    [t,y] = ode15s( @tryptophan1 ,tspan ,[y1_0, y2_0, y3_0, y4_0]);  %tryptophan evaluates r.h.s. of the ode
